...
import com.unpas.masteringmaths.student.activity.StudentPostActivity
...
class StudentPostsFragment : Fragment(), PostItemListener {
    ...
    override fun onUpdateClick(
        teacherId: String, toolbarName: String, isEdited: Boolean, isAssignment: Boolean,
        post: String, postTitle: String?, postId: String
    ) {

        val intent = Intent(context, StudentPostActivity::class.java)
    ...
    private fun setupDatabse() {
        ...
        adapter.setTeacherId(teacherId)
