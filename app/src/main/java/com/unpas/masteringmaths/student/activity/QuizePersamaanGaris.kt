...
class QuizePersamaanGaris : AppCompatActivity() {
    ...
    private fun addData() {
        listSoal = ArrayList()
        for (a in 1..10) {
            listSoal.add("file:///android_asset/soal_kemiringan_$a.html")
        }
    }

    private fun addAnswerA() {
        answerA.add("3/5")
        answerA.add("2\uD835\uDC66+\uD835\uDC65^2−10=0")
        answerA.add("−3/2")
        answerA.add("1/2")
        answerA.add("1")
        answerA.add("-2")
