...
import kotlinx.android.synthetic.main.activity_student_exam.btn_answer
import kotlinx.android.synthetic.main.activity_student_exam.btn_next
import kotlinx.android.synthetic.main.activity_student_exam.btn_prev
import kotlinx.android.synthetic.main.activity_student_exam.content_soal
import kotlinx.android.synthetic.main.activity_student_exam.main_answer_img
import kotlinx.android.synthetic.main.activity_student_exam.main_answer_text
import kotlinx.android.synthetic.main.activity_student_exam.no_soal
import kotlinx.android.synthetic.main.activity_sudent_quize.*
import kotlinx.android.synthetic.main.text_answer.*
import java.util.*
import java.util.concurrent.TimeUnit

class QuizePolaBilangan : AppCompatActivity() {
        ...
        btn_answer.setOnClickListener {
            ...
            if (kondisi) {
                ...
                if (isFinish) {
                    ...
                    intent.putExtra(QuizePythagorasActivity.MY_POINT, point)
                    intent.putExtra(QuizePythagorasActivity.TRUE_ANSWER, benar)
                    intent.putExtra(QuizePythagorasActivity.FALSE_ANSWER, salah)
                    intent.putExtra(QuizePythagorasActivity.TIMER, waktu.text.toString())
