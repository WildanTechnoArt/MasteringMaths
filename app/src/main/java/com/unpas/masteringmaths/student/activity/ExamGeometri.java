...
public class ExamGeometri extends AppCompatActivity {
        ...
        btnNext.setOnClickListener(view -> {
            if (kondisi) {
                ...
                if (indext < listSoal.size()-1){
                    ...
                    Intent intent = new Intent(ExamGeometri.this,StudentResultExamActivity.class);
    ...
    private void addData(){
        ...
        for (int a = 1; a<=10; a++){
            listSoal.add("file:///android_asset/soal_geometri_"+a+".html");
        }
    }
    ...
    private void addAnswerA() {
        ...
        answerA.add("378");
        answerA.add("0");
        answerA.add("Rp. 30.880.000,-");
        answerA.add("1720");
        answerA.add("400");
        answerA.add("630");
        answerA.add("360 cm");
        answerA.add("Rp. 4.750.000,-");
        answerA.add("Rp. 525.000,-");
    }
    ...
    private void addAnswerB() {
        ...
        answerB.add("256");
        answerB.add("-1");
        answerB.add("Rp. 25.680.000,-");
        answerB.add("1560");
        answerB.add("350");
        answerB.add("310");
        answerB.add("370 cm");
        answerB.add("Rp. 3.750.000,-");
        answerB.add("Rp. 535.000,-");
    }
    ...
    private void addAnswerC() {
        ...
        answerC.add("125");
        answerC.add("-2");
        answerC.add("Rp.  20.480.000,-");
        answerC.add("1320");
        answerC.add("310");
        answerC.add("256");
        answerC.add("378 cm");
        answerC.add("Rp. 2.750.000,-");
        answerC.add("Rp. 545.000,-");
    }
    ...
    private void addAnswerD() {
        ...
        answerD.add("75");
        answerD.add("-3");
        answerD.add("Rp.  15.280.000,-");
        answerD.add("1260");
        answerD.add("250");
        answerD.add("64");
        answerD.add("570 cm");
        answerD.add("Rp. 1.750.000,-");
        answerD.add("Rp. 555.000,-");
    }
