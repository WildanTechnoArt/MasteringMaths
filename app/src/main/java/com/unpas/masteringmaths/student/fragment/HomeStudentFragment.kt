...
import kotlinx.android.synthetic.main.senior_lesson_layout.view.*
...
class HomeStudentFragment : Fragment(), HomeFragmentView.View {
    ...
    private fun getClassCount(view: View) {
        ...
        db.addOnSuccessListener {
            ...
            view.tv_class1_count?.text = "$classCount Class Participated in"
            view.tv_pencacahan_count?.text = "$classCount Class Participated in"
        }
    }
    ...
    private fun seniorLesson() {
        ...
        card_tiga_dimensi.setOnClickListener {
            val intent = Intent(context, SeniorLessonActivity::class.java)
            intent.putExtra(NUMBER_LESSON, 6)
            startActivity(intent)
        }

        card_trigonometri.setOnClickListener {
            val intent = Intent(context, SeniorLessonActivity::class.java)
            intent.putExtra(NUMBER_LESSON, 7)
            startActivity(intent)
        }

        card_transformasi.setOnClickListener {
            val intent = Intent(context, SeniorLessonActivity::class.java)
            intent.putExtra(NUMBER_LESSON, 8)
            startActivity(intent)
        }
    }
