...
import com.unpas.masteringmaths.main.adapter.FirestoreChatAdapter
...
class StudentChatActivity : AppCompatActivity() {
    ...
    private fun getChatMessage(){
        ...
        adapter = FirestoreChatAdapter(this, options)
    ...
    private fun prepare() {
        ...
        friendId = intent?.getStringExtra(TEACHER_ID).toString()
    ...
    private fun getPhotoUrl(){
        ...
        db.collection("photos")
            ...
            .addOnSuccessListener {
                val photoUrl = it.getString("thumbUrl").toString()
                GlideApp.with(this)
                    .load(photoUrl)
