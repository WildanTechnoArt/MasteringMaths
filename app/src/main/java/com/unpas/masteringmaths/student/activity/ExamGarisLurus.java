...
public class ExamGarisLurus extends AppCompatActivity {
        ...
        btnNext.setOnClickListener(view -> {
            if (kondisi) {
                ...
                if (indext < listSoal.size()-1){
                    ...
                    Intent intent = new Intent(ExamGarisLurus.this,StudentResultExamActivity.class);
    ...
    private void addData(){
        ...
        for (int a = 1; a<=10; a++){
            listSoal.add("file:///android_asset/soal_garislurus_"+a+".html");
        }
    }

    private void addAnswerA() {
        answerA.add("y=−2x+4");
        answerA.add("y=−5/8 x−5");
        answerA.add("4y – 3x – 12 = 0");
        answerA.add("7x – 12y = 9");
        answerA.add("\uD835\uDC66=−\uD835\uDC65+1\n");
        answerA.add("y=3x+2");
        answerA.add("\uD835\uDC65+8\uD835\uDC66+30=0");
        answerA.add("4\uD835\uDC65−\uD835\uDC66−7=0");
        answerA.add("8x + 12y = 75 ");
        answerA.add("8");
    }

    private void addAnswerB() {
        answerB.add("y=−2x−4");
        answerB.add("y=5/8 x−5");
        answerB.add("4y – 3x + 12 = 0");
        answerB.add("7x – 12y = 13");
        answerB.add("\uD835\uDC66=2\uD835\uDC65−1");
        answerB.add("y=2x+3");
        answerB.add("\uD835\uDC65+8\uD835\uDC66−30=0");
        answerB.add("4\uD835\uDC65−\uD835\uDC66+7=0");
        answerB.add("y=−2/3 x+4");
        answerB.add("6");
    }

    private void addAnswerC() {
        answerC.add("y−2x+4=0");
        answerC.add("y=−5/8 x+5");
        answerC.add("4y + 3x – 12 = 0");
        answerC.add("7x + 12y = 9");
        answerC.add("\uD835\uDC66=−2\uD835\uDC65−1");
        answerC.add("y+2x=3");
        answerC.add("\uD835\uDC65−8\uD835\uDC66+30=0");
        answerC.add("4\uD835\uDC65+\uD835\uDC66−7=0");
        answerC.add("8x – 12y = 75");
        answerC.add("4");
    }

    private void addAnswerD() {
        answerD.add("y−2x−4=0");
        answerD.add("y=5/8 x+5");
        answerD.add("4y + 3x + 12 = 0");
        answerD.add(" 7x + 12y = 13");
        answerD.add("\uD835\uDC66=\uD835\uDC65+1");
        answerD.add("y+3x=2");
        answerD.add("\uD835\uDC65−8\uD835\uDC66−30=0");
        answerD.add("4\uD835\uDC65+\uD835\uDC66+7=0");
        answerD.add("y=−2/3 x+8");
        answerD.add("2");
    }
