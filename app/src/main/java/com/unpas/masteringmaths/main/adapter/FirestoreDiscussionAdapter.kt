...
class FirestoreDiscussionAdapter(private val context: Context, private val options: FirestoreRecyclerOptions<ForumMessage>) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int, item: ForumMessage) {
