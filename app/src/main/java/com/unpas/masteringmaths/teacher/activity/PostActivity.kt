...
class PostActivity : AppCompatActivity(), PostView.View {
            ...
            R.id.post -> {
                if (post != null) {
                    if (isEdited == true) {
                        ...
                        presenter.updateData(getPostId, photoUrl, post, nip, username, userId, userId, classId, className)
                    } else {
                        presenter.postData(photoUrl, post, nip, username, userId, userId, classId, className)
                    }
                } else {
